        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">SMARTZDWELL</h2>
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li>
                            ...
                            <a class="text-decoration-none" href="mailto:info@company.com">info@smartzdwell.com</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            Copyright &copy; 2023 SMARTZDWELL 
                            | Designed by <a rel="sponsored" href="#" target="_blank">SOFTDEVIATION</a>
                        </p>
                    </div>
                </div>
            </div>
